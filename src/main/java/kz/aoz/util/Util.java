...
public class Util {
    ...
    public static GsonImportResult getGsonImportResult(Boolean result, Object data, String messageTex) {
        GsonImportResult gson = new GsonImportResult();
        gson.setResult(result);
        gson.setResultData(data);
        gson.setResultText(messageTex);
        return gson;
    }
}
